...
/**
 * swap_node_behind - For swaping a node in a listint_t doubly-linked
...
/**
 * swap_node_ahead - For swaping a node in a listint_t doubly-linked list
...
/**
 * cocktail_sort_list - For sorting a listint_t doubly-linked list of integers in
